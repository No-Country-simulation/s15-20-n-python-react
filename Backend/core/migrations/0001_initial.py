    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True,
                 primary_key=True, serialize=False, verbose_name='ID')),
                ('role_type', models.CharField(choices=[('EDITOR', 'Editor'), (
                    'COMMENTATOR', 'Comentarista'), ('READER', 'Lector')], default='READER', max_length=20)),
                ('status', models.CharField(max_length=100, null=True)),
                ('is_active', models.BooleanField(default=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='core.roletype')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(max_length=100, null=True)),
                ('is_active', models.BooleanField(default=True)),
                ('membership_project', models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(max_length=100, null=True)),
                ('is_active', models.BooleanField(default=True)),
                ('associate_task', models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('commented_task', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='core.task')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(max_length=100, null=True)),
                ('is_active', models.BooleanField(default=True)),
                ('membership_board', models.ForeignKey(
